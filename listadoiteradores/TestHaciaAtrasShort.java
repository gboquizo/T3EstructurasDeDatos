...
public class TestHaciaAtrasShort {
	private static ArrayList<Short> shorts = new ArrayList<Short>();
	private static ListIterator<Short> it = shorts.listIterator();
	...
	private static void iteradorAlFinal() {
		it = shorts.listIterator(shorts.size());
	}
